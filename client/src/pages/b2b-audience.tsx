...
export default function B2BAudiencePage() {
  ...
  return (
    <>
      ...
      {/* Enhanced B2B Audience Banner */}
      <div className="relative overflow-hidden bg-gradient-to-br from-[#0a0a1a] via-primary/20 to-[#0a0a1a] text-white">
        <div className="absolute inset-0">
          {/* Background gradients */}
          <div className="absolute inset-0">
            <motion.div
              className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(var(--primary),0.3),transparent_70%)]"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.3, 0.5, 0.3],
              }}
        ...
        <div className="container mx-auto px-4 py-24 relative">
          <div className="max-w-4xl">
            ...
            <motion.h1
              ...
              className="text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-white/80"
            >
