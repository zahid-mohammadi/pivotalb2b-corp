...
import { BarChart3, Building2, Users, Target, Filter, MapPin, Database, Laptop, Globe, CheckCircle, Network, ArrowRight, Shield, Clock } from "lucide-react";
...
export default function B2BAudiencePage() {
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden bg-[#0a0a1a] text-white">
