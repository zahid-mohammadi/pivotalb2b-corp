      ...
      <div className="container mx-auto py-16">
        ...
        <section aria-labelledby="leadership-heading">
          <motion.div {...fadeInUp} className="mb-32">
            <h2 id="leadership-heading" className="text-5xl font-bold mb-16 text-center bg-gradient-to-r from-primary via-purple-600 to-pink-600 text-transparent bg-clip-text">
              Leadership
            </h2>
        ...
        <section aria-labelledby="purpose-heading">
          <motion.div {...fadeInUp} className="mb-32 relative">
            ...
            <h2 id="purpose-heading" className="text-5xl font-bold mb-16 text-center">Our Purpose</h2>
        ...
        <section aria-labelledby="values-heading">
          <motion.div {...fadeInUp} className="mb-32">
            <h2 id="values-heading" className="text-5xl font-bold mb-16 text-center">Our Values</h2>
        ...
        <section aria-labelledby="expertise-heading">
          <motion.div {...fadeInUp} className="mb-32">
            <h2 id="expertise-heading" className="text-5xl font-bold mb-16 text-center">Our Expertise</h2>
          ...
          <motion.div {...fadeInUp} className="mb-32">
            <div className="relative py-16 rounded-3xl overflow-hidden">
              ...
              <div className="relative">
                <h2 id="impact-heading" className="text-5xl font-bold mb-16 text-center">Our Impact</h2>
        ...
        <section aria-labelledby="media-heading">
          <motion.div {...fadeInUp} className="mb-32">
            <div className="relative py-16 rounded-3xl overflow-hidden bg-gradient-to-br from-slate-900 via-primary/90 to-slate-900 text-white">
              <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-[0.1]" />
              <div className="relative">
                <h2 id="media-heading" className="text-5xl font-bold mb-16 text-center text-white">Our Media Property</h2>
