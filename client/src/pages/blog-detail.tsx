...
export default function BlogDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-16">
      ...
      {/* Hero banner section */}
      <div className="w-full bg-gradient-to-br from-primary/15 via-primary/5 to-background relative overflow-hidden">
        {/* Decorative elements */}
              ...
              <div className="bg-muted/30 p-6 rounded-xl border border-muted">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button 
                    variant="outline" 
                    size="icon" 
                    className="rounded-full hover:bg-blue-500/10 hover:text-blue-500 transition-all"
                    onClick={() => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(directPost.title)}&url=${encodeURIComponent(window.location.href)}`, '_blank')}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    size="icon" 
                    className="rounded-full hover:bg-blue-600/10 hover:text-blue-600 transition-all"
                  ...
                  <Button 
                    variant="outline" 
                    size="icon" 
                    className="rounded-full hover:bg-blue-700/10 hover:text-blue-700 transition-all"
