...
export const invoices = pgTable("invoices", {
  ...
  viewTrackingToken: varchar("view_tracking_token", { length: 64 }).unique(),
  sentAt: timestamp("sent_at"),
  emailOpenedAt: timestamp("email_opened_at"),
  lastEmailOpenAt: timestamp("last_email_open_at"),
  emailOpenCount: integer("email_open_count").default(0).notNull(),
  emailTrackingToken: varchar("email_tracking_token", { length: 64 }).unique(),
  lastReminderAt: timestamp("last_reminder_at"),
  reminderCount: integer("reminder_count").default(0).notNull(),
  reminderHistory: jsonb("reminder_history"),
...
export const insertInvoiceSchema = createInsertSchema(invoices)
  ...
  .extend({
    ...
    viewTrackingToken: z.string().optional(),
    sentAt: z.string().datetime().optional(),
    emailOpenedAt: z.string().datetime().optional(),
    lastEmailOpenAt: z.string().datetime().optional(),
    emailOpenCount: z.number().optional(),
    emailTrackingToken: z.string().optional(),
    lastReminderAt: z.string().datetime().optional(),
    reminderCount: z.number().optional(),
    reminderHistory: z.any().optional(),
